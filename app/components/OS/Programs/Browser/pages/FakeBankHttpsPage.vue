...
const url = 'https://mybank-online.ru'
...
<template>
  <div class="bank-page bank-page--https">
    ...
    <footer class="bank-page__footer">
      <div class="bank-page__secure-info">
        <UIcon name="i-lucide-shield-check" />
        <span>Соединение защищено (HTTPS)</span>
      </div>
    </footer>
  </div>
</template>
